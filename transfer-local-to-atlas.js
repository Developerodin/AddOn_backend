...
const LOCAL_MONGODB_URL = process.env.LOCAL_MONGODB_URL || 'mongodb://localhost:27017/addon';
const ATLAS_MONGODB_URL = process.env.ATLAS_MONGODB_URL || process.env.MONGODB_URL;
